...
script.on_event(defines.events.on_tick, function()
  for player_index, drag_state in pairs(storage.drag) do
    local clear_cursor = drag_state.player.mod_settings["even-distribution-clear-cursor"].value --[[@as boolean]]
    if not clear_cursor then
      local ticks = drag_state.player.mod_settings["even-distribution-ticks"].value --[[@as int]]
